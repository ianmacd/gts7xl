...
char *reset_history_buf;
uint32_t reset_history_size;
char *reset_history_read_buf;
struct debug_reset_header *reset_history_info;
...
static int __init sec_debug_reset_reason_init(void)
{
	...
	entry = proc_create("reset_history", S_IWUGO, NULL,
